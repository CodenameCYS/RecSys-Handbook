...
| --- | --- | --- | --- | --- |
| [基础与特征交叉](./基础与特征交叉/README.md) | 稀疏字段如何编码，哪些字段组合需要显式或隐式交互 | [LR、Wide & Deep](./基础与特征交叉/LR与WideDeep/README.md)、[DeepFM](./基础与特征交叉/DeepFM/README.md) | 字段含义、词表和离在线特征一致 | 用深层网络掩盖错误特征或泄漏 |
| [用户兴趣建模](./用户兴趣建模/README.md) | 当前候选应激活用户历史中的哪些兴趣 | [DIN](./用户兴趣建模/DIN/README.md)、[DIEN](./用户兴趣建模/DIEN/README.md) | 事件序列可信，候选与历史存在相关性 | 把无序、无语义的日志拼成兴趣序列 |
| [序列建模](./序列建模/README.md) | 行为顺序、时间间隔和长距离依赖如何建模 | [BST](./序列建模/BST/README.md)、[SASRec](./序列建模/SASRec/README.md)、[BERT4Rec](./序列建模/BERT4Rec/README.md) | 序列足够长，顺序和时间可稳定回放 | 用长模型替代对短序列与冷启动的处理 |
| [多任务学习](./多任务学习/README.md) | CTR、CVR、时长、风险等任务怎样共享或隔离 | [ESMM](./多任务学习/ESMM/README.md)、[MMoE](./多任务学习/MMoE/README.md)、[PLE](./多任务学习/PLE/README.md) | 各任务标签口径清楚且关系可解释 | 将结构共享等同于多目标排序策略 |
| [多场景与迁移](./多场景与迁移/README.md) | 多入口、多地域或多业务线如何共享与适配 | [STAR](./多场景与迁移/STAR/README.md)、[场景自适应](./多场景与迁移/场景自适应/README.md) | 场景 ID 稳定、各场景样本与差异可量化 | 将噪声分桶或流量波动当成场景差异 |
